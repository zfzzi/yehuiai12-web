...
const toolIcons: Array<{ tool: CanvasTool; icon: typeof PenLine }> = [
  { tool: "局部重绘", icon: PenLine },
  { tool: "遮罩选择", icon: Blend },
...
export function CanvasStage({
  ...
  function renderDraftFixture() {
    ...
    if (draftFixture.mode === "line" && draftFixture.kind) {
      return (
        <g className={`annotation-draft annotation-fixture-line fixture-line-${draftFixture.kind}`}>
          <line
            className="fixture-line-path"
    ...
    if (draftFixture.mode === "area") {
      ...
      return (
        <g className="annotation-draft annotation-fixture-area">
          <rect
            className="annotation-area-rect"
            x={area.x}
            y={area.y}
    ...
    if (draftFixture.mode === "point") {
      return (
        <g className="annotation-draft annotation-fixture-point">
          <circle
    ...
    return (
      <g className="annotation-draft annotation-fixture-direction">
        <line
          className="fixture-direction-line"
          markerEnd="url(#fixture-arrow)"
          x1={draftFixture.startX}
      ...
      <div className="canvas-board">
        <div className="canvas-control-row">
          ...
          <div className="canvas-control-cluster">
            ...
            <label className="canvas-time-control">
              <SunMoon size={14} aria-hidden="true" />
              <span className="visually-hidden">时间段</span>
              <select
                aria-label="选择夜景时间段"
                value={selectedTime}
                onChange={(event) =>
        ...
        <div className={hasResult ? "compare-control" : "compare-control is-disabled"}>
          <span>原图</span>
          <input
            aria-label="前后对比滑杆"
            type="range"
